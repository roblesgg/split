...
(function () {
  ...
  var PATHS = {
    /* ---------- para las cuentas ----------
       Una cuenta es un sitio donde tienes dinero, y cada uno tiene su
       forma: el banco no se parece a la hucha ni al sobre de efectivo.
       Van en el mismo trazo que los demás —24x24, 1,7 px, currentColor—
       para que en una fila se lean como una familia y no como pegatinas
       traídas de fuera. */

    /* el banco de toda la vida: frontón y columnas */
    banco:    '<path d="M3.2 9.5 12 4.5l8.8 5"/><path d="M5 9.5V18M9.7 9.5V18M14.3 9.5V18M19 9.5V18"/><path d="M3 18h18"/><path d="M2.6 20.8h18.8"/>',
    /* tarjeta, con su banda y su chip */
    tarjeta:  '<rect x="2.8" y="5.5" width="18.4" height="13" rx="2.4"/><path d="M2.8 10h18.4"/><path d="M6.5 14.8h3.2"/>',
    /* caja fuerte: la rueda es lo que la distingue de una caja */
    caja:     '<rect x="3" y="4.5" width="18" height="15" rx="2.2"/><circle cx="10.5" cy="12" r="3.4"/><path d="M10.5 8.6V12l2.2 1.4"/><path d="M17.4 9.5v5"/>',
    /* monedas apiladas, que es como se dibuja el ahorro */
    monedas:  '<ellipse cx="12" cy="6.5" rx="7.5" ry="2.8"/><path d="M4.5 6.5v5c0 1.6 3.4 2.8 7.5 2.8s7.5-1.2 7.5-2.8v-5"/><path d="M4.5 11.5v5c0 1.6 3.4 2.8 7.5 2.8s7.5-1.2 7.5-2.8v-5"/>',
    /* el móvil, para el dinero que vive en una app */
    movil:    '<rect x="6.5" y="2.8" width="11" height="18.4" rx="2.4"/><path d="M10.5 5.6h3"/><path d="M12 17.8h.01"/>',
    /* sobre: el efectivo que se aparta a mano */
    sobre:    '<rect x="2.8" y="5.5" width="18.4" height="13" rx="2.2"/><path d="m3.4 6.7 8.6 6 8.6-6"/>',
    /* avión, para el bote del viaje */
    avion:    '<path d="M10.4 3.6a1.7 1.7 0 0 1 3.2 0l.9 6.1 6.3 3.4v2.3l-6.6-1.7-.7 3.6 2.2 1.8v1.4l-3.7-1.1-3.7 1.1v-1.4l2.2-1.8-.7-3.6-6.6 1.7v-2.3l6.3-3.4Z"/>',
    /* gema: lo que se guarda y no se toca */
    gema:     '<path d="M7.5 4h9l4 5.2L12 20 3.5 9.2Z"/><path d="M3.5 9.2h17"/><path d="m7.5 4 1.7 5.2L12 20l2.8-10.8L16.5 4"/>',
    /* paraguas: el colchón para cuando llueve */
    paraguas: '<path d="M12 3.2v1.4"/><path d="M2.9 12.6a9.1 9.1 0 0 1 18.2 0Z"/><path d="M12 12.6v6.2a2.2 2.2 0 0 1-4.4 0"/>',
    /* carrito de la compra ya existe (cart); este es el ticket */
    ticket:   '<path d="M5 3.5h14v17l-2.3-1.6-2.3 1.6-2.4-1.6-2.3 1.6-2.4-1.6L5 20.5Z"/><path d="M8.6 8.5h6.8"/><path d="M8.6 12.5h6.8"/>',
